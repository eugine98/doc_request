      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const closeDialog = async () => {
            requestStatus == 8 && await update_req_status(employee.c_req_id, employee.c_id, "", "", "", 'true')
            set_mail("");
            // await refetchCount();
            fetch_count_pending_coc_for_hr()
            await fetch_pending_coc_for_hr();
            setIsOpen(false);
          }
          ...
          const update_req_status = async (req_id: string, id: string, req_status: string, action: string, doc_type: string, update_archive: string) => {
            try {
                ...
                await axios.post(`${API_SERVER_URL}/Api/update_coc_req_status`, formdata);
        ...
        useEffect(() => {
            console.log("hello: ", requestStatus)
        },[])
          return (
            <>
          <div>
                  ...
                  <AlertDialogHeader>
                      ...
                      <Accordion type="single" collapsible className="w-full">
                              ...
                              {requestStatus == 0 && (
                               ...
                               <Dialog>
                                ...
                                <Button
                                  ...
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '1', 'done', 'COC', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 1 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '0', 'undone', 'COC', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                             ...
                             <div>
                              ...
                              {requestStatus == 1 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '2', 'done', 'COC', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 2 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '1', 'undone', 'COC', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                             ...
                             <div>
                              ...
                              {requestStatus == 2 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '3', 'done', 'COC', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 3 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '2', 'undone', 'COC', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                          ...
                          <AccordionItem value="item-3">
                            <AccordionTrigger className={` text-[0.8rem] pt-3 pb-3 ${requestStatus > 3 ? 'text-green-600' : 'text-red-600'}`}>
                                Accounting Staff will do the COC and print.
                            </AccordionTrigger>
                            <AccordionContent>
                            <div>
                            <div>
                              ...
                              {requestStatus == 3 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '4', 'done', 'COC', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 4 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '3', 'undone', 'COC', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                          ...
                          <AccordionItem value="item-4">
                            ...
                            Accounting Staff will give the printed COC to their Accounting Manager for her sign.
                            </AccordionTrigger>
                            <AccordionContent>
                            <div>
                            <div>
                              ...
                              {requestStatus == 4 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '5', 'done', 'COC', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 5 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '4', 'undone', 'COC', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                          ...
                          <AccordionItem value="item-5">
                            <AccordionTrigger className={` text-[0.8rem] pt-3 pb-3 ${requestStatus > 5 ? 'text-green-600' : 'text-red-600'}`}>
                                Accounting Staff will transmitted back the Signed COC to Hr Staff
                                </AccordionTrigger>
                            <AccordionContent>
                            <div>
                            <div>
                              ...
                              {requestStatus == 5 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '6', 'done', 'COC', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 6 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '5', 'undone', 'COC', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                            ...
                            <AccordionContent>
                              ...
                              {requestStatus == 6 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '7', 'done', 'COC', employee.c_employee_name)}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 7 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '6', 'undone', 'COC', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                            ...
                            <div>
                              ...
                              {requestStatus == 7 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '8', 'done', 'COC', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 8 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '7', 'undone', 'COC', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                  ...
                  <Tooltip>
                    ...
                    <div className="bg-orange-600 p-1 rounded-sm hover:cursor-pointer" onClick={() => { openDialog();
                          if(employee.c_req_status == 'Hr Staff to validate the request form'){
                            ...
                            setRequestStatus(2)
                          }else if(employee.c_req_status == 'Accounting Staff will do the COC and print.'){
                            setRequestStatus(3)
                          }else if(employee.c_req_status == 'Accounting Staff will give the printed COC to their Accounting Manager for her sign.'){
                            setRequestStatus(4)
                          }else if(employee.c_req_status == 'Accounting Staff will transmitted back the Signed COC to Hr Staff'){
                            setRequestStatus(5)
