...
import {
  ...
  export function DataTableCF1() {
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          const closeDialog = async () => {
            requestStatus == 8 && await update_cf1_req_status(employee.c_req_id, employee.c_id, "", "", "", 'true')
            set_mail("");
            // await refetchCount();
            fetch_count_pending_cf1_for_hr
            await fetch_pending_cf1_for_hr();
            setIsOpen(false);
          }
          ...
          const update_cf1_req_status = async (req_id: string, id: string, req_status: string, action: string, doc_type: string, update_archive: string) => {
            try {
                ...
                await axios.post(`${API_SERVER_URL}/Api/update_cf1_req_status`, formdata);
        ...
        const reject_request = async (req_id: string, id: string, receiptName: string) => {
          if(rejection_reason != "" && mail != "" && mail != undefined ){
              try {
                ...
                formdata.append("table_type", "CF1");
        ...
        const send_email = async (receiptName: string) => {
          try {
              const formdata = new FormData();
              formdata.append("header", "CF1 Rejection Notice");
              formdata.append("doc_type", 'CF1');
        ...
        const for_claim_email = async (receiptName: string) => {
          try {
              const formdata = new FormData();
              formdata.append("header", "CF1 For Claim");
              formdata.append("doc_type", 'CF1');
              formdata.append("receiptEmailAdd", mail);
              formdata.append("sender", empData.first_name);
              formdata.append("receiptName", receiptName);
        ...
        const confirm = async (receiptName: string) => {
          await update_cf1_req_status(reqID, ID, reqStatus, buttonType, docType, 'false');
          if(buttonType == 'done'){
            if(reqStatus == "7"){
                  ...
                  <AlertDialogHeader>
                      <AlertDialogTitle>
                        <div className="flex justify-between">
                          <p>CF1 <span className='text-[0.6rem] mt-2.5 text-gray-400'>(only 1 year and above tenure)</span></p>
                      ...
                      <Accordion type="single" collapsible className="w-full">
                              ...
                              {requestStatus == 0 && (
                               ...
                               <Dialog>
                                ...
                                <Button
                                  ...
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '1', 'done', 'CF1', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 1 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '0', 'undone', 'CF1', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                             ...
                             <div>
                              ...
                              {requestStatus == 1 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '2', 'done', 'CF1', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 2 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '1', 'undone', 'CF1', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                             ...
                             <div>
                              ...
                              {requestStatus == 2 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '3', 'done', 'CF1', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 3 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '2', 'undone', 'CF1', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                          ...
                          <AccordionItem value="item-3">
                            <AccordionTrigger className={` text-[0.8rem] pt-3 pb-3 ${requestStatus > 3 ? 'text-green-600' : 'text-red-600 '}`}>Accounting Staff will process the CF1.</AccordionTrigger>
                            <AccordionContent>
                            <div>
                            <div>
                                {requestStatus > 3 ? (
                              ...
                              {requestStatus == 3 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '4', 'done', 'CF1', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 4 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '3', 'undone', 'CF1', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                          ...
                          <AccordionItem value="item-4">
                            ...
                            Accounting Staff will give the CF1 to their Accounting Manager for her sign.
                            {/* <div className="flex justify-start">
                                  <p>
                                  For Sign
                                  </p>
                            ...
                            <div>
                              ...
                              {requestStatus == 4 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '5', 'done', 'CF1', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 5 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '4', 'undone', 'CF1', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                          ...
                          <AccordionItem value="item-5">
                            <AccordionTrigger className={` text-[0.8rem] pt-3 pb-3 ${requestStatus > 5 ? 'text-green-600' : 'text-red-600 '}`}>Accounting Staff will transmitted back the Signed CF1 to Hr Staff</AccordionTrigger>
                            <AccordionContent>
                            <div>
                            <div>
                                {requestStatus > 5 ? (
                              ...
                              {requestStatus == 5 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '6', 'done', 'CF1', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 6 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '5', 'undone', 'CF1', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                          ...
                          <AccordionItem value="item-6">
                            <AccordionTrigger className={`text-[0.8rem] pt-3 pb-3 ${requestStatus > 6 ? 'text-green-600' : 'text-red-600 '}`}>Hr Staff to notify the EE</AccordionTrigger>
                            <AccordionContent>
                              <div>
                                  {requestStatus > 6 ? (
                                        <p>Done!</p>
                              ...
                              {requestStatus == 6 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '7', 'done', 'CF1', employee.c_employee_name)}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 7 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '6', 'undone', 'CF1', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
                          ...
                          <AccordionItem value="item-7">
                            <AccordionTrigger className={`text-[0.8rem] pt-3 pb-3 ${requestStatus > 7 ? 'text-green-600' : 'text-red-600 '}`}>EE to claim and sign the receiving copy.</AccordionTrigger>
                            <AccordionContent>
                            <div>
                            <div>
                                {requestStatus > 7 ? (
                              ...
                              {requestStatus == 7 && (
                                ...
                                <Button
                                  ...
                                  size="sm"
                                  className="bg-green-600 text-white hover:bg-green-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '8', 'done', 'CF1', '')}
                                >
                                  Done 
                                </Button>
                                </div>
                                ...
                                {requestStatus == 8 && (
                                  ...
                                  size="sm"
                                  className="bg-red-600 text-white hover:bg-red-500 hover:text-white"
                                  onClick={() => update_status(employee.c_req_id, employee.c_id, '7', 'undone', 'CF1', '')}
                                  >
                                  Undone 
                                  </Button>
                                </div>
              ...
              <TooltipProvider delayDuration={100}>
                  <Tooltip>
                    ...
                    <div className="bg-orange-600 p-1 rounded-sm hover:cursor-pointer" onClick={() => { openDialog();
                          if(employee.c_req_status == 'Hr Staff to validate the request form'){
                            setRequestStatus(0)
                          }else if(employee.c_req_status == 'Hr Staff to submit the request form to the HR Manager for her sign'){
                            setRequestStatus(1)
                          }else if(employee.c_req_status == 'Hr Staff will transmit the signed request form to Accounting Staff'){
                            setRequestStatus(2)
                          }else if(employee.c_req_status == 'Accounting Staff will process the CF1.'){
                            setRequestStatus(3)
                          }else if(employee.c_req_status == 'Accounting Staff will give the CF1 to their Accounting Manager for her sign.'){
                            setRequestStatus(4)
                          }else if(employee.c_req_status == 'Accounting Staff will transmitted back the Signed CF1 to Hr Staff'){
                            setRequestStatus(5)
                          }else if(employee.c_req_status == 'Hr Staff to notify the EE'){
                            setRequestStatus(6)
    ...
    const fetch_pending_cf1_for_hr = async () => {
      try {
        const formdata = new FormData();
        ...
        const response = await axios.post(
          `${API_SERVER_URL}/Api/fetch_pending_cf1_for_hr`,
          formdata
        );
    ...
    const fetch_count_pending_cf1_for_hr = async () => {
      try {
        const formdata = new FormData();
        formdata.append("is_pending", 'pending');
        formdata.append("for_search", forSearch);
        formdata.append("col_type", filterBy.replace('_', '.'));
        const response = await axios.post(
          `${API_SERVER_URL}/Api/fetch_count_pending_cf1_for_hr`,
          formdata
        );
    ...
    //   queryKey: ['itr_count'],
    //   queryFn: fetch_count_pending_cf1_for_hr,
    //   staleTime: 10 * 1000,
