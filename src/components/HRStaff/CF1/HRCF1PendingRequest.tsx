  ...
  const columns: ColumnDef<PendingITR>[] = [
    {
      ...
      cell: ({ row }) => (
        <div className="capitalize">
          {row.getValue("c_id_no") != "" ? row.getValue("c_id_no") : "-"}
        </div>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <div className="capitalize">{row.getValue("c_employee_name")}</div>
      ),
    },
    {
    ...
    },
    {
      ...
      header: "Emp_status",
      cell: ({ row }) => (
        <div className="capitalize">{row.getValue("c_emp_status")}</div>
      ),
    },
    {
      ...
      header: "Req_Status",
      cell: ({ row }) => (
        <div className="capitalize">{row.getValue("c_req_status")}</div>
      ),
    },
    {
      id: "actions",
      ...
      cell: ({ row }) => {
        ...
        const update_cf1_req_status = async (
          req_id: string,
          id: string,
          req_status: string,
          action: string,
          ...
          try {
            ...
            await axios.post(
              `${API_SERVER_URL}/Api/update_cf1_req_status`,
              formdata
            );
                  ...
                  <AlertDialogHeader>
                    <AlertDialogTitle>
                      <div className="flex justify-between">
                        <p>
                          CF1{" "}
                          <span className="text-[0.6rem] mt-2.5 text-gray-400">
                            (only 1 year and above tenure)
                          </span>
                        </p>
                        <div className="">
                          <X
                    ...
                    <Accordion type="single" collapsible className="w-full">
                      <AccordionItem value="item-1">
                        <AccordionTrigger
                          className={`text-[0.8rem] pt-3 pb-3 ${
                            requestStatus > 0
                              ? "text-green-600"
                              : "text-red-600 "
                          }`}
                      ...
                      <AccordionItem value="item-3">
                        ...
                        >
                          Accounting Staff will process the CF1.
                        </AccordionTrigger>
                        <AccordionContent>
                          <div>
                            <div>
                      ...
                      <AccordionItem value="item-4">
                        ...
                        >
                          Accounting Staff will give the CF1 to their Accounting
                          Manager for her sign.
                          {/* <div className="flex justify-start">
                                  <p>
                                  For Sign
                                  </p>
                      ...
                      <AccordionItem value="item-5">
                        ...
                        >
                          Accounting Staff will transmitted back the Signed CF1
                          to Hr Staff
                        </AccordionTrigger>
                        <AccordionContent>
                          <div>
                        ...
                        <div
                          ...
                          onClick={() => {
                            ...
                            if (
                              ...
                              employee.c_req_status ==
                              "Accounting Staff will transmitted back the Signed CF1 to Hr Staff"
                            ) {
                              setRequestStatus(5);
                            } else if (
                              employee.c_req_status ==
        ...
        <div className="rounded-md border">
          <Table>
            ...
            <TableBody
              ...
              className=" text-[0.6rem] text-gray-900"
            >
