...
<div className="h-full px-2 py-2 overflow-y-auto  dark:bg-gray-800 ">
      ...
      >
         ...
         <motion.p className="self-center font-semibold whitespace-nowrap dark:text-white z-20 text-[0.7rem] text-gray-800  hidden sm:block pt-1.5 pb-0.5" style={{fontFamily: "Poppins, sans-serif"}}>Document Request</motion.p>
      </motion.div>
      <motion.ul  className=" text-[0.65rem] sm:text-xs text-gray-900 mt-4" style={{ fontFamily: "Fredoka, sans-serif"}}>
        <li className="hover:cursor-pointer pt-[0.03rem] pb-[0.03rem]" onClick={()=> navigate("/HR-ITR")}>
            <div className={`flex items-center p-2 rounded-md hover:bg-slate-200 hover:shadow-sm group hover:text-black ${location.pathname == "/HR-ITR" ? "bg-gray-200 shadow-md font-semibold text-gray-950" : 'text-white' }`}>
               <NotebookPen strokeWidth={location.pathname === '/HR-ITR' ? 3 : undefined} className='w-4 h-4 pb-0.5 hidden sm:block'/>
         ...
         <li className="hover:cursor-pointer pt-[0.03rem] pb-[0.03rem] " onClick={()=> navigate("/HR-COE")}>
            ...
            >
               <NotebookPen strokeWidth={location.pathname === '/HR-COE' ? 3 : undefined}  className='w-4 h-4 pb-0.5 hidden sm:block'/>
         ...
         <li className="hover:cursor-pointer pt-[0.03rem] pb-[0.03rem] " onClick={()=> navigate("/HR-COC")}>
            ...
            >
               <NotebookPen strokeWidth={location.pathname === '/HR-COC' ? 3 : undefined}  className='w-4 h-4 pb-0.5 hidden sm:block' />
         ...
         <li className="hover:cursor-pointer pt-[0.03rem] pb-[0.03rem] " onClick={()=> navigate("/HR-CF1")}>
            ...
            >
               <NotebookPen strokeWidth={location.pathname === '/HR-CF1' ? 3 : undefined}  className='w-4 h-4 pb-0.5 hidden sm:block' />
         ...
         <li className="hover:cursor-pointer pt-[0.03rem] pb-[0.03rem]  " onClick={()=> navigate("/HR-13Month")}>
            ...
            >
               <NotebookPen strokeWidth={location.pathname === '/HR-13Month' ? 3 : undefined}  className='w-4 h-4 pb-0.5 hidden sm:block'/>
