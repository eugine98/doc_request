...
import {
  ...
  export function DataTableClaimedMonthPay() {
          ...
          <div>
            <AlertDialog open={isOpen} onOpenChange={setIsOpen}>
              <AlertDialogContent className='w-96'>
                <AlertDialogHeader>
                  ...
                  <AlertDialogFooter>
                    ...
                    <AlertDialogAction onClick={() => remove_from_claim_list(employee.t_req_id)} className="h-8">Yes</AlertDialogAction>
                  </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
          </div>
              ...
              <TooltipProvider delayDuration={100}>
                  <Tooltip>
                    <TooltipTrigger>
                        <div className="bg-[#ff0000] p-1 rounded-sm hover:cursor-pointer" onClick={() => openDialog()}>
                          ...
                          <form className="w-full space-y-4 p-3 bg-white rounded shadow-md text-gray-700 text-[0.65rem] font-medium" 
                            ...
                            >
                              ...
                              {employee.t_emp_status != 'active' && (
                                ...
                                <div>
                                      <label htmlFor="thirteen_month" className="block">2316 / ITR for the year:</label>
                                      <input 
                                        disabled type="text" id="thirteen_month" className='mt-1 block w-full border rounded-md p-2' 
