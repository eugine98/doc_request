...
const onSubmit = async (data: FormData) => {
  try {
    ...
    const response = await axios.post(`${API_SERVER_URL}/Api/add_thirteen_request`, formdata);
    if(response.data.code == 0){
      ...
      toast.success('', {
        className: 'my-classname',
        description: "Your request for 13th Month Pay has been successfully submitted.",
        duration: 2500,
